...
export default function About() {
  ...
  return (
    <React.Fragment>
      <div className="container xl:relative max-w-7xl mx-auto mt-52 md:mt-16 h-auto lg:h-[650px]">
        ...
        <div className="flex flex-col items-center xl:block mt-8 xl:mt-0 px-4 md:px-0">
          ...
          <div className="bg-Blond20 mt-8 xl:mt-0 xl:absolute z-10 xl:top-72 xl:left-44 p-12 pl-14 max-w-[390px] md:max-w-[550px] rounded-3xl drop-shadow-lg md:drop-shadow-xl">
            <h2 className="text-2xl md:text-5xl text-center md:text-left font-bold mb-6">
              Participants
            </h2>
